...
const serviceAccount = {
    ...
    clientEmail: "firebase-adminsdk-fbsvc@sorteo-xpress.iam.gserviceaccount.com",
...
export function isAdminReady(): { ready: boolean; message: string } {
    ...
    if (!adminApp || !adminFirestore) {
        return {
            ready: false,
            message: 'El SDK de Admin no se pudo inicializar. Las credenciales no parecen estar configuradas.'
        };
    }
