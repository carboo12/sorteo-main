...
import { Home, Ticket, Users, LogOut, Building, Settings, ShieldAlert, History, Award } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { href: '/dashboard/reports', label: 'Premios', icon: <Award />, roles: ['superuser', 'admin'] },
